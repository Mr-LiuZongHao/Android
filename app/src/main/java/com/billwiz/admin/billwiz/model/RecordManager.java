...
import com.billwiz.admin.billwiz.db.DB;
...
//                coCoinRecord.delete(BillWizApplication.getAppContext(), new DeleteListener() {
//                    @Override
//                    public void onSuccess() {
//                        if (BuildConfig.DEBUG) {
//                            if (BuildConfig.DEBUG) Log.d("CoCoin",
...
//get records from server to local//////////////////////////////////////////////////////////////////
    ...
    public static long getRecordsFromServer() {
        ...
        query.findObjects(BillWizApplication.getAppContext(), new FindListener<CoCoinRecord>() {
            @Override
