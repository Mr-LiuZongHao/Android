...
public class AppUpdateManager {
    ...
    public void checkUpdateInfo(final Boolean showInfo) {
        ...
        query.addWhereGreaterThan("version", BillWizApplication.VERSION);
        query.setLimit(Integer.MAX_VALUE);
        query.findObjects(BillWizApplication.getAppContext(), new FindListener<APK>() {
            @Override
            public void onSuccess(final List<APK> object) {
                ...
                tooOldQuery.addWhereEqualTo("version", BillWizApplication.VERSION);
                tooOldQuery.setLimit(1);
                tooOldQuery.findObjects(BillWizApplication.getAppContext(), new FindListener<APK>() {
                    @Override
