package com.billwiz.admin.billwiz.ui.guillotine.animation;
...
import com.billwiz.admin.billwiz.ui.guillotine.util.ActionBarInterpolator;
import com.billwiz.admin.billwiz.ui.guillotine.util.GuillotineInterpolator;
...
public class GuillotineAnimation {
    ...
    public static class GuillotineBuilder {
        ...
        public com.billwiz.admin.billwiz.ui.guillotine.animation.GuillotineAnimation build() {
            return new com.billwiz.admin.billwiz.ui.guillotine.animation.GuillotineAnimation(this);
        }
    }
}
