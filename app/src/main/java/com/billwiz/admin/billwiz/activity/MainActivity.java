...
import com.billwiz.admin.billwiz.model.AppUpdateManager;
...
import com.billwiz.admin.billwiz.ui.CoCoinScrollableViewPager;
import com.billwiz.admin.billwiz.ui.DummyOperation;
import com.billwiz.admin.billwiz.ui.MyGridView;
import com.billwiz.admin.billwiz.ui.guillotine.animation.GuillotineAnimation;
import com.billwiz.admin.billwiz.ui.guillotine.interfaces.GuillotineListener;
import com.billwiz.admin.billwiz.util.CoCoinToast;
...
//        Bmob.initialize(BillWizApplication.getAppContext(), CoCoin.APPLICATION_ID);
//        CrashReport.initCrashReport(BillWizApplication.getAppContext(), "900016815", false);
//        RecordManager.getInstance(BillWizApplication.getAppContext());
//        CoCoinUtil.init(BillWizApplication.getAppContext());
    ...
    private void showToast(int toastType) {
        switch (toastType) {
            ...
            case PRESS_AGAIN_TO_EXIT:
                ...
                break;
            case WELCOME_BACK:
                CoCoinToast.getInstance().showToast(BillWizApplication.getAppContext()
